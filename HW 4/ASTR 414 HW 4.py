# -*- coding: utf-8 -*-
"""
Created on Sat Feb 17 15:04:42 2018
...
all_wvlngths = []
all_wvlngths.append(wavelength)
all_transmissions = []
...
for value in all_filters:
     all_wvlngths.append(value['col2'])
     all_transmissions.append(value['col3'])

for i in range(len(all_wvlngths)):
    plt.plot(all_wvlngths[i], all_transmissions[i], color = colors[i], label = all_names[i])
